...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, User userDetails) throws JsonProcessingException {
        ...
        extraClaims.put("BusinessUnit_id", userDetails.getBusinessUnit().getId());
        extraClaims.put("BusinessUnit_name", userDetails.getBusinessUnit().getName());
        extraClaims.put("platform_id", userDetails.getPlatformEntity().getId());
        extraClaims.put("platform_name", userDetails.getPlatformEntity().getName());

        extraClaims.put("UserRole_name", userDetails.getUserRole().getName());
